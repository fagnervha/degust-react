export const portuguese = {
  ...
  "After completing the order, you will receive a": "Após concluir o pedido, você receberá",
  ...
  "Start exploring the best services around you.":
    "Comece a explorar os melhores serviços perto de você.",
  ...
  "Search for items or store...": "Pesquisar itens ou lojas...",
  Stores: "Lojas",
  "Filter Search Results": "Filtrar Resultados de Busca",
  ...
  "You have item from another store in cart. If you continue, your all previous item from cart will be removed":
    "Você tem um item de outra loja no carrinho. Se você continuar, todos os itens anteriores do carrinho serão removidos",
  ...
  "is not available right now. You can order it later.": "não está disponível agora. Você pode pedir mais tarde.",
  ...
  "View Saved Address": "Ver Endereços",
  ...
  "Minimum 200 points required to convert into currency": "Mínimo de 200 pontos necessários para converter em saldo",
  ...
  "Communicate with our support team to get proper guidance to your quaternaries.":
    "Comunique-se com nossa equipe de suporte para obter orientação adequada.",
  "VISIT US": "VISIT US",
  "EMAIL US": "EMAIL US",
  "CALL US": "CALL US",
  ...
  "Restaurant is closed. Try again later.": "Restaurante fechado. Tente novamente mais tarde.",
  ...
  "We will be back very soon.": "Voltaremos muito em breve.",
  Organic: "Orgânico",
  "Theme mode": "Theme mode",
  ...
  "Without any payment method, you can not place the order.":
    "Sem um método de pagamento, você não poderá fazer o pedido.",
  Subscribe: "Subscribe",
  ...
  "for the first time, make sure to use the referral code": "pela primeira vez, certifique-se de usar o código de indicação",
