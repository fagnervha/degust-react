export const portuguese = {
  ...
  "Nutrition Details": "Informações Nutricionais",
  "Whats New": "Novidades",
  ...
  "After completing the order, you will receive a":
    "Após concluir o pedido, você receberá um cashback de",
  ...
  "cashback. The minimum purchase required to avail this offer is":
    " A compra mínima exigida para aproveitar" + " esta oferta é",
  ...
  "Your total price must be more then coupon amount":
    "Seu preço total deve ser superior ao valor do cupom",
  "You can use this ID to track your order later":
    "Você pode usar esse ID para rastrear seu pedido depois",
  "Cart item remove successfully": "Item do carrinho removido com sucesso",
  ...
  "Has  paid by your wallet.": "Pagou com sua carteira.",
  ...
  "(Choose Payment Method)": "(Selecione uma forma de pagamento)",
  ...
  "Best Reviewed Items": "Itens mais bem avaliados",
  ...
  "Parcel Delivery Information": "Dados para Entrega de Encomendas",
  ...
  "Sender or Receiver location is missing":
    "Endereço do remetente ou destinatário está ausente",
  "please login first": "Por favor, faça login primeiro",
  "Wallet balance is below total amount.":
    "O saldo da carteira está abaixo do valor total.",
  Color: "Color",
  ...
  "Your cart has been cleared successfully. Now try to add the product again.":
    "Seu carrinho foi limpo com sucesso. Agora tente adicionar o produto novamente.",
  "items in your cart": "itens em seu carrinho",
  ...
  "You have nothing in your cart to checkout.":
    "Não há nada em seu carrinho para finalizar a compra.",
  "Choose Your Interests": "Escolha Seus Interesses",
  "Get personalized food recommendations.":
    "Receba recomendações personalizadas de comidas.",
  ...
  "Earn money to your wallet by completing the offer & challenged":
    "Ganhe dinheiro em sua carteira ao completar ofertas e desafios",
  "Convert your loyalty points into wallet money":
    "Converta seus pontos em saldo na carteira",
  "Send your wallet money while order":
    "Envie dinheiro para sua carteira durante o pedido",
  "Admin also reward their top customers with wallet money":
    "O aplicativo também recompensa seus principais clientes com dinheiro na carteira",
  ...
  "is not available right now. You can order it later.":
    "está indisponível agora. Você pode pedir mais tarde.",
  ...
  "View Saved Address": "Endereços Salvos",
  ...
  "Minimum 200 points required to convert into currency":
    "Mínimo de 200 pontos necessários para converter em saldo",
  "Convert your loyalty point to wallet money.":
    "Converta seus pontos degust em saldo na carteira.",
  ...
  "Positive Review": "Avaliações Positivas",
  ...
  "Are you sure you want to switch this order to Cash On Delivery?":
    "Tem certeza de que deseja mudar este pedido para Pagamento na entrega?",
  ...
  "Do you want to login or continue as a guest?":
    "Deseja fazer login ou continuar como visitante?",
  "Please search some keywords.": "Por favor, pesquise algumas palavras-chave.",
  "Are you sure you want to delete this address?":
    "Tem certeza de que deseja excluir esse endereço?",
  ...
  "You have food from another restaurant in cart. If you continue, your all previous food from cart will be removed":
    "You have food from another restaurant in cart. If you continue, your all previous food from cart will be removed",
  "Are you sure, you want to reset?": "Tem certeza de que deseja reiniciar?",
  ...
  "Communicate with our support team to get proper guidance to your quaternaries.":
    "Fale com nossa equipe de suporte para obter orientação adequada",
  "VISIT US": "ENDEREÇO",
  "EMAIL US": "EMAIL",
  "CALL US": "TELEFONE",
  ...
  "Choose one from your existing messages, or start a new one.":
    "Escolha uma de suas mensagens existentes ou inicie uma nova.",
  ...
  "Addons Price": "Preço Do Complemento",
  ...
  "Connect with our social media and other sites to keep up to date":
    "Conecte-se à nossas redes sociais e a outros sites para se manter atualizado",
  "% off": "% off",
  Register: "Register",
  ...
  "Your order is placed Successfully. We start our delivery process and you will receive your food soon.":
    "Seu pedido foi realizado com sucesso. Iniciamos nosso processo de envio e você receberá sua comida em breve.",
  "point.": "point.",
  "It will add to your balance when the order is delivered.":
    "Ele será adicionado ao seu saldo quando o pedido for entregue.",
  ...
  "To select from saved addresses, you need to sign in.":
    "Para escolher endereços salvos, é necessário fazer login.",
  ...
  "phone number required": "número de celular obrigatório",
  ...
  "Maximum 3 images can be send at a time.":
    "No máximo 3 imagens podem ser enviadas por vez.",
  ...
  "This Variation needs to be selected in between minimum":
    "Esta variação precisa ser selecionada entre o mínimo",
  "and maximum": "e o máximo",
  "items.": "items.",
  "Enter the verification code (OTP) sent to":
    "Digite o código de verificação (OTP) enviado para",
  ...
  "Password can not be updated while you are logged in by using social logins.":
    "A senha não pode ser atualizada enquanto você estiver conectado por meio de redes sociais.",
  "Previously added restaurant foods have been removed from cart. Now, try again.":
    "Comidas de restaurante adicionadas anteriormente foram removidas do carrinho. Agora, tente novamente.",
  ...
  "Your payment has been successfully processed, and your order ":
    "Seu pagamento foi realizado com sucesso, e seu pedido ",
  "has been placed.": "foi realizado",
  "If you accidentally provided incorrect payment information, you can edit the details in the order details section while the order is still pending.":
    "Se você acidentalmente forneceu dados de pagamento incorretos, poderá editar os detalhes na seção de detalhes do pedido enquanto o pedido ainda estiver pendente.",
  Get: "Ganhe",
  ...
  "A store must be selected to continue":
    "Uma loja deve ser selecionada para continuar",
  ...
  "The total amount of the order, exceeds maximum amount of the cash on delivery method":
    "O valor total do pedido excede o valor máximo para envio com pagamento na entrega",
  ...
  "To apply this coupon, total order amount should be minimum":
    "Para aplicar esse cupom, o valor total do pedido deve ser no mínimo",
  "Point to wallet transfer successfully.":
    "Transferência de ponto para carteira bem-sucedida.",
  "Item Price": "Preço do Item",
  "Vat/Tax (Included)": "Iva/Tax (Incluído)",
  Clear: "Limpar",
  Included: "Incluído",
  ...
  "We will be back very soon.": "Estaremos de volta muito em breve.",
  Organic: "Orgânico",
  "Theme mode": "Modo do tema",
  "What’s Wrong With This Order?": "O que há de errado com esse pedido?",
  "Getting Order List...": "Recebendo a Lista de Pedidos...",
  "Add Cutlery": "Adicionar Talheres",

  "Dont have a cutlery? Restaurant will provide you.":
    "Não tem talheres? O restaurante lhe fornecerá.",
  ...
  "Quality Medicines & Health care at your Doorstep.":
    "Medicamentos de qualidade e cuidados de saúde na sua porta.",
  "Get your groceries items delivered in less than an hour":
    "Receba suas compras em menos de uma hora",
  "partially paid amount": "valor pago parcialmente",
  "Notify me when it is back": "Avise-me quando estiver de volta",
  ...
  "Avoid calling phone": "Evite me ligar",
  ...
  "Are you sure to change the language?":
    "Tem certeza de que deseja alterar o idioma?",
  "The browser will refresh to get translated content.":
    "O browser será atualizado para exibir o conteúdo traduzido.",
  No: "Não",
  "We are under maintenance.": "We are under maintenance.",
  "added via": "added via",
  "Popular in this store!": "Popular in this store!",
  "Add to cart": "Por no Carrinho",
  "Sort by : High to Low": "Ordenar por : Alto a Baixo",
  "Sort by : Low to High": "Ordenar por : Baixo a Alto",
  ...
  "Upload your prescriptions here and get your medicine right at your door step":
    "Faça o upload de suas receitas aqui e receba seu medicamento na porta de sua casa",
  "Upload Prescriptions": "Upload Prescriptions",
  "Need to order same medicine? don’t worry just click here":
    "Precisa pedir o mesmo medicamento? não se preocupe, basta clicar aqui",
  "Refill Request": "Refill Request",
  "Visit Again!": "Visit Again!",
  "Get your recent medicine from the store you recently visited":
    "Finalize a compra na loja que você que você visitou recentemente",
  ...
  "6amMart is a Laravel and Flutter Framework-based multi-vendor food, grocery, eCommerce, parcel, and pharmacy delivery system. It has six modules to cover all your business functionality.":
    "Degust is a Laravel and Flutter Framework-based multi-vendor food, grocery, eCommerce, parcel, and pharmacy delivery system. It has six modules to cover all your business functionality.",
  ...
  "Add fund by from secured digital payment gateways":
    "Adicionar saldo por meio de pagamento digital",
  ...
  "this page or go back to previous page":
    "esta página ou voltar para a página anterior",
  "Go Back": "Voltar",
  ...
  "Note must not be grater than 191 characters":
    "A observação não deve ter mais de 191 caracteres",
  ...
  "Sorry you can’t delete your account !":
    "Desculpe, mas não é possível excluir sua conta!",
  "You won’t be able to recover your data again":
    "Você não poderá recuperar seus dados novamente",
  ...
  "If you're checking out": "Se você estiver visitando o",
  "for the first time, make sure to use the referral code":
    "pela primeira vez, certifique-se de usar o código de indicação",
  ...
  "You made your earning when the order is complete":
    "Seus ganhos são obtidos quando o pedido é concluído",
  "They create a account on 6amMart using your code and place their first order":
    "Eles criam uma conta no Degust usando seu código e fazem seu primeiro pedido",
  "They create a account on": "Eles criam uma conta no",
  "using your code and place their first order":
    "usando seu código e fazem seu primeiro pedido",
  ...
  "seller info": "Dados do vendedor",
  "See Chat History": "Ver Histórico do Chat",
  "Unit Price": "Preço Unitário",
  "How was your experience with your last order ?":
    "Como foi sua experiência com seu último pedido?",
  "Share us your valuable feedbacks":
    "Compartilhe conosco seu valioso feedback",
  "Rate the item": "Avaliar o produto",
  Groceries: "Groceries",
  "Make sure to remember your ": "Make sure to remember your ",
  "order ID and phone number": "pedido ID e número de celular",
  ...
  "Select a Payment Method to Proceed": "Escolha uma forma de pagamento para prosseguir",
  ...
  "According to government regulations, prescription is mandatory for ordering some medicines.":
    "De acordo com as regulamentações governamentais, a prescrição é obrigatória para o pedido de alguns medicamentos.",
  "No problem if you can't understand the doctor's handwriting, our Pharmacist will assist you in ordering the medicine by viewing the prescription.":
    "Não há problema se você não conseguir entender a letra do médico, nosso farmacêutico o ajudará a fazer o pedido do medicamento visualizando a receita.",
  "Max size 2MB": "Tamanho max 2MB",
  ...
  "This charge includes extra vehicle charge": "Essa cobrança inclui a taxa extra do veículo",
  ...
  "Pick Location": "Defina a Localização",
  "Add to Cart": "Por no Carrinho",
  "Search location": "Buscar localização",
  "Copied!": "Copiado!",
  "Massage to ": "Mensagem para ",
  "Custom Massage": "Mensagem Personalizada",
  "Type here to write a custom message": "Digite aqui para escrever uma mensagem personalizada",
  "Send Massage": "Enviar Mensagem",
  "No favourite foods found": "Nenhum alimento favorito encontrado",
  "Interest updated successfully": "Interesse atualizado com sucesso",
  "Min Spent": "Compra Min",
  "Track Now": "Rastrear",
  "Estimated delivery:": "Previsão de entrega:",
  "Addons": "Complementos",
  "Preparing foods": "Preparo de alimentos",
  " foods is on the way": " comida esta a caminho",
  "No options": "Nenhuma opção",
  "Wanna Try  Again!!": "Quer experimentar novamente?",
  "Get your recent food from the restaurant you recently ordered": "Peça a comida que você pediu recentemente no restaurante",
  " is closed. Try again later.": " esta fechado",
  ...
  "Sharing your accurate location enhances precision in search results and delivery estimates, ensures effortless order delivery.":
    "Compartilhar sua localização exata melhora a precisão nos resultados de busca e estimativas de entrega, garantindo uma entrega de pedido sem esforço",
  "Order Placed": "Pedido Realizado",
  "Order confirmed": "Pedido Confirmado",
  "address type": "tipo de endereço",
};
